...
public class AdminDashboard extends JFrame {
    ...
    public AdminDashboard() {
        ...
        tabbedPane.addTab("Section Management", new SectionManagementPanel());
    ...
    private JPanel createMaintenanceBanner() {
        ...
        JLabel message = new JLabel("MAINTENANCE MODE ACTIVE: Student and Instructor write operations are blocked.");
